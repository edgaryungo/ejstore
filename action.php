...
if(isset($_POST["category"])){
	...
	echo "
		<div class='nav nav-pills nav-stacked'>
			<li class='active'><a href='#'><h4>Liquor</h4></a></li>
	";
...
if(isset($_POST["getProduct"])){
	...
	if(mysqli_num_rows($run_query) > 0){
        ...
        <div class="col-sm-4 col-md-4 panel panel-info" >

          <div class="panel-body">
              <div class="panel-heading">
                <?php echo $name;?>
             </div>
          <img src="<?php echo 'images/'.$image; ?>" style="width: 250px;height: 150px;">
          <div class="panel-heading"><?php echo $decription;?></div>

             <div class="price-value" style="position: relative;left: 125px; ">
       ...
       <button class="btn btn-danger my-cart-btn" data-id="<?php $id;?>" data-name="<?php $name;?>" data-summary="<?php echo $decription;?>" data-price="<?php echo $price;?>" data-quantity="1" data-image="<?php echo'images/'.$image;?>">Add to Cart</button>
        </div>
        </div>
  </div>
</div>	
	...
	if (isset($_POST["checkOutDetails"])) {
		if (mysqli_num_rows($query) > 0) {
			...
			echo "<form method='post' action='login_form.php'>";
				...
				if (!isset($_SESSION["uid"])) {
					echo '<input type="submit" style="float:right;" name="login_user_with_product" class="btn btn-info btn-lg" value="Checkout" >
							</form>';
					...
					/*echo '
						...
						<form action="admindemo.php" method="post">
							...
							<input type="hidden" name="business" value="meshackkipkorir105@gmail.com.com">
					...
					echo '
						...
						<form action="customer_order_details.php" method="post">
							...
							while($row=mysqli_fetch_array($query)){
								...
								echo ' <input style="float:right;margin-right:80px;" type="submit" name="submit" value="submit">
								     </form >';
